...
20010 PRINT "{13}{WHITE}"

I=64
FOR Y=1 TO 4: FOR X=1 TO 8: OF=(Y)*40+X+13: POKE 1024+OF,I: I=I+1: NEXT X: NEXT Y
FOR Y=4 TO 8: FOR X=1 TO 8: OF=(Y+12)*40+X+14: POKE 1024+OF,I: I=I+1: NEXT X: NEXT Y
20120 RETURN
